...
El juego se basa en que se decide un número aleatorio que se mantiene en secreto para el usuario. Este debe ingresar un número, el cual es comparado con el número secreto y se muestra una pista de qué tan cerca se está del número secreto en una escala de frío a caliente. Estos números se guardan en una lista y el proceso se repite hasta que se adivine el número secreto. 
...
Video demostración de app en teléfono: https://drive.google.com/file/d/1Yjejt7Fp8oDht95zKn3rGMTI3VTKcBum/view?usp=sharing
